...
export default function Sample() {
  ...
  const getFile = async (id) => {
    const fitchedFile = await axios.get(`api/files/${id}`);
    setFitchedFile(fitchedFile.data);
    console.log(`http://localhost:5000${fitchedFile.data.pdfLink}`);
  };
